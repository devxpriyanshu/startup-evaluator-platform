const D=[
  {id:'tech',name:'M1 · Technology readiness',pts:25,pct:21,c:'#185fa5',bg:'#e6f1fb',tc:'#0c447c',bc:'#b5d4f4',
   ...
   fields:[
     ...
     {n:'Engineering scalability & architecture',max:3,type:'Continuous · (score−1)÷4×3',
      rows:[['1 — Bespoke: custom engineering per installation','0 pts'],['2 — Significant scale-up engineering challenges','0.75 → 1 pt'],['3 — Scalable with major capital investment','1.5 → 2 pts'],['4 — Modular: standard engineering replication','2.25 → 2 pts'],['5 — Plug-and-play: inherently scalable architecture','3 pts (max)']],note:'Repeatable engineering is a prerequisite for profitable EPC deployment. the investor cannot build a margin on bespoke installations.'},
  ...
  {id:'ip',name:'M2 · IP & Patent Assessment',pts:15,pct:12.5,c:'#534ab7',bg:'#eeedfe',tc:'#3c3489',bc:'#afa9ec',
   why:'Without defensible IP, the investor\'s investment creates value that competitors can freely replicate. A non-patented technology becomes a commodity the day funding is announced. IP is also the primary lever for the investor to extract licensing revenue from its own project portfolio.',
   fields:[
     ...
     {n:'Claim quality & defensibility',max:4,type:'Linear · direct score 0–4 (requires IP counsel input)',
      rows:[['0 — No claims or trivially narrow claims','0 pts'],['1 — Narrow method claims; easily designed around','1 pt'],['2 — Moderate scope; some design-around risk','2 pts'],['3 — Broad claims covering core inventive concept','3 pts'],['4 — Very broad claims; confirmed strong by IP counsel','4 pts (max)']],note:'IMPORTANT: This field should be scored by a qualified patent attorney, not the evaluator alone. the investor should build a standard IP counsel review into the due diligence process for any investment above ₹5 Cr.'},
     ...
     {n:'Institutional IP origin clarity',max:4,type:'Linear · direct score 0–4',
      rows:[['0 — No clear institutional origin; disputed ownership','0 pts'],['1 — Founder-developed independently; clean ownership','1 pt'],['2 — Developed at IIT/IISc/NIT; clean IP assignment confirmed','2 pts'],['3 — Co-developed with industry; licensing terms clear','3 pts'],['4 — Developed under DST/BIRAC grant; commercialisation rights confirmed','4 pts (max)']],note:'IP assignment disputes (especially in IIT spin-outs where the institute holds partial rights) are a common deal-blocker in Indian deep-tech. the investor must verify IP ownership chain before any term sheet.'}
   ]},
  ...
  {id:'mkt',name:'M4 · Market Validation',pts:20,pct:16.7,c:'#ba7517',bg:'#faeeda',tc:'#633806',bc:'#fac775',
   ...
   fields:[
     {n:'TAM — Total Addressable Market (global, USD)',max:4,type:'Continuous · TAM score − 1',
      rows:[['1 — < $500M global market','0 pts'],['2 — $500M – $2B global market','1 pt'],['3 — $2B – $10B global market','2 pts'],['4 — $10B – $50B global market','3 pts'],['5 — > $50B global market','4 pts (max)']],note:'$500M global TAM can support a venture but limits the investor\'s strategic upside. Most meaningful deep-tech energy markets (green hydrogen, CCUS, storage) have TAMs above $10B, so this field tends to reward sectors rather than individual companies.'},
     {n:'SAM — Serviceable Market in India (₹ Crores)',max:2,type:'Continuous · (score−1)÷4×2',
      rows:[['1 — < ₹500 Crores India market','0 pts'],['2 — ₹500 – ₹2,000 Crores','0.5 → 1 pt'],['3 — ₹2,000 – ₹10,000 Crores','1 pt'],['4 — ₹10,000 – ₹50,000 Crores','1.5 → 2 pts'],['5 — > ₹50,000 Crores India addressable','2 pts (max)']],note:'Lower weight than TAM because the investor\'s primary deployment market is India. SAM is the actionable near-term number. A high TAM but low SAM signals that India market development is still early — important for timeline planning.'},
  ...
  {id:'adopt',name:'M5 · Adoption Feasibility',pts:15,pct:12.5,c:'#a32d2d',bg:'#fcebeb',tc:'#791f1f',bc:'#f09595',
   ...
   fields:[
     ...
     {n:'Customer CapEx requirement per deployment',max:5,type:'Continuous · (score−1)×1.2, rounded',
      rows:[['1 — > ₹500 Crores: prohibitive; requires GOI financing','0 pts'],['2 — ₹100–500 Crores: high; strategic-level sign-off needed','1 pt'],['3 — ₹10–100 Crores: moderate; capital budgeting cycle','2 pts'],['4 — ₹1–10 Crores: manageable for mid-size industry','4 pts'],['5 — < ₹1 Crore: low; SaaS or service model','5 pts (max)']],note:'High CapEx extends sales cycles from months to years and limits buyer universe to large PSUs. the investor\'s EPC relationships can help structure financing (IREDA, VGF) to reduce effective CapEx for customers — this strategic lever should be noted in the evaluation.'},
  ...
  {id:'eil',name:'M7 · Strategic Fit',pts:10,pct:8.3,c:'#0c447c',bg:'#e6f1fb',tc:'#042c53',bc:'#85b7eb',
   why:'This overlay module converts a generic investment assessment into an the investor-specific decision. A startup scoring 90/120 on the general framework but with zero EPC relevance and no sector alignment should not receive DeepTechEval funds — your firm has a specific mandate, not a general venture capital mandate.',
   fields:[
     {n:'Alignment with your core investment sectors',max:3,type:'Continuous · (score−1)÷4×3',
      rows:[['1 — Outside the investor\'s sector scope entirely','0 pts'],['2 — Adjacent; loosely related to the investor work','0.75 → 1 pt'],['3 — Within the investor sectors but not a core area','1.5 → 2 pts'],['4 — Core the investor sector: hydrocarbons / renewables / water','2.25 → 2 pts'],['5 — Central to the investor\'s declared strategic priorities','3 pts (max)']],note:'the investor sectors: Hydrocarbons, Renewable Energy, Water, Biofuels, Waste-to-Energy, Industrial IIoT, Engineering Services. A technology falling squarely within these gets 3 pts. One outside this list — regardless of commercial merit — gets 0.'},
     {n:'EPC integration potential',max:4,type:'Continuous · score−1 (scale 1–5)',
      rows:[['1 — No EPC relevance; standalone consumer product','0 pts'],['2 — Peripheral; usable in a narrow set of project types','1 pt'],['3 — Integrable as component in standard the investor EPCM projects','2 pts'],['4 — Core technology for the investor\'s renewable/green EPCM mandate','3 pts'],['5 — Transforms the investor\'s competitive position in a major sector','4 pts (max)']],note:'HIGHEST WEIGHT field in Module 7 (4 pts) because EPC integration is the investor\'s unique structural advantage over financial investors. the investor can provide deployment opportunities that no VC can match. A technology with strong EPC potential is worth significantly more to the investor than to a pure financial investor.'},
     {n:'National energy program alignment',max:3,type:'Continuous · (score−1)÷4×3',
      rows:[['1 — Unrelated to India\'s declared energy transition priorities','0 pts'],['2 — Peripherally related','0.75 → 1 pt'],['3 — Supports India\'s 500 GW Renewable Energy target by 2030','1.5 → 2 pts'],['4 — Core to National Hydrogen Mission / Green Steel / CCUS','2.25 → 2 pts'],['5 — Critical-path to INDC commitments / 2070 Net Zero','3 pts (max)']],note:'National program alignment unlocks GOI financing (VGF, IREDA loans, PLI benefits) and assured off-take from PSUs under government mandate. This dramatically de-risks commercial deployment and improves the investor\'s risk-adjusted return.'},
     {n:'Technology licensing revenue potential for the investor',max:1,type:'Binary threshold · score≥3 → 1 pt; score<3 → 0',
      rows:[['1–2 — No identifiable licensing potential for the investor','0 pts'],['3 — Possible; the investor could license in specific project contexts','1 pt'],['4–5 — Significant licensing income across the investor project portfolio','1 pt (max)']],note:'Low weight (1pt) because licensing revenue is speculative at early stage. This is a directional signal, not a quantified projection. A startup with strong IP (Module 2 score ≥ 10) AND high licensing potential should receive special attention in the Strategic Value Adjustment section of the valuation.'},
     {n:'the investor engagement alignment — founder appetite',max:1,type:'Binary threshold · score≥3 → 1 pt; score<3 → 0',
      rows:[['1–2 — Founders want capital only; actively resist strategic PSU role for the investor','0 pts'],['3 — Open to the investor as strategic partner with right terms','1 pt'],['4–5 — Actively seeking the investor as anchor customer + EPCM + co-investor','1 pt (max)']],note:'A technically excellent startup whose founders do not want the investor involved beyond writing a cheque is not a good strategic fit. the investor\'s value-add (network, projects, PSU relationships) can only be realised if the startup welcomes the investor\'s active involvement.'}
   ]}
];
